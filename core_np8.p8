...
--@conf
--[[
autotiles={{52, 54, 53, 39, 33, 35, 34, 55, 49, 51, 50, 48, 36, 38, 37, [0] = 32}, {0, 0, 0, 0, 67, 69, 68, 0, 99, 101, 100, 0, 83, 85, 84, 114, 115, 116, 117, [0] = 67}}
composite_shapes={}
param_names={"lavadir", "is_hot", "lavaspd", "isepicenter"}
]]
--@begin
--[[level table
...
local __init = _init function _init() __init() load_level(1) music(-1) max_djump=2 end
--@end
