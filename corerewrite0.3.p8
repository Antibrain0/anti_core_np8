...
if _ENV.hide==false then 
 if _ENV.cd==false then
  ...
  for i in all(_ENV.segments) do
   ...
   spr(118,(_ENV.x+_ENV.segments[#_ENV.segments].x)/2,(_ENV.y+_ENV.segments[#_ENV.segments].y)/2)
  end
  pal()
 end
elseif player_here() then
...
heart={
  ...
  draw=function(_env)
   if _env.hide==false then
    sspr(64,32,8,16,_env.x,_env.y)
    sspr(64,32,8,16,_env.x+8,_env.y,8,16,true)
   end
    if _env.show then
      pal()
      camera()
...
heart={
  ...
  draw=function(_ENV)
   if _ENV.hide==false then
    sspr(16,32,8,16,_ENV.x,_ENV.y)
    sspr(16,32,8,16,_ENV.x+8,_ENV.y,8,16,true)
   end
    if _ENV.show then
      pal()
      camera()
...
__gfx__

...

...

...
__gff__

...

...

__sfx__
